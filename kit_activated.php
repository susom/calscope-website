        ...
        <div class="row">
          <div id="received-invitation"  class="col-md-12 invitation-kit-1-item received-invitation d-flex flex-column justify-content-center">
            ...
            <div class="received-invitation-access-code access-sec-form">
              <form id="invite" method="post">
                ...
                <div class="btn-row">
                  <div class="g-recaptcha" data-sitekey="6Ldc0RYaAAAAAKwveQ1vAVgxDYJHmPokTqHUugrv"></div>
                  <br/>
          ...
          <div id="got-kit"  class="col-md-12 p-0 invitation-kit-1-item-wrp got-kit">
            <div class="got-kit-wrap">
              ...
              <div class='got-kit-start'>
                <img src="./assets/images/pic_kitbox.png" >
                <div class="btn-row">
                  <a href="https://artemis.gauss.com/#/qr-scan-instruction" class="btn btn-danger start_activation" tabindex="0"><?=$lang["btn_start"]?></a>
                </div>
              </div>
              <div class='got-kit-activate access-sec-form'>
                <form id="activate" method="post" action="">
                <div class="form-group">
                  <input type="text" class="form-control" name="activation_code" id="activation_code" name="" placeholder="<?=$lang["placeholder_activation"]?>" required="required">
                  <div class="activation-code-error"></div>
                </div>
                <div class="form-group">
                  <input type="text" class="form-control" name="zip_activation" id="zip_activation" name="" placeholder="<?=$lang["placeholder_zip"]?>" required="required">
                </div>
                <div class="btn-row">
                  <div class="g-recaptcha" data-sitekey="6Ldc0RYaAAAAAKwveQ1vAVgxDYJHmPokTqHUugrv"></div>
                  <br/>
                  <button type="button" class="btn btn-danger redirect-activation"><?=$lang["btn_confirm"]?></button>
                </div>
                </form>
              </div>
            </div>
